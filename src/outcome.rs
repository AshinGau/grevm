...
pub enum TxExecutionOutcome {
    ...
    /// The transaction was invalid at the committed state and skipped according to the configured
    /// policy. The exact revm validation error is forwarded to the consumer.
