...
/// Serializes access to a `Send` database so it can be shared by scheduler workers.
///
/// This favors a small integration surface. Callers with a natively concurrent database should
/// pass that database directly to [`crate::Scheduler`].
